...
def apply_default_view_extrinsics(vis: o3d.visualization.Visualizer, sensor_t_world: np.ndarray) -> None:
...
def main() -> None:
    """脚本入口：读取点云并启动可视化窗口。"""
    xyz, intensity = load_lidar_npy("/home/saimo/work/render/output/lidar.npy")
